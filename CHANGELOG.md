...
### Removed
- **BREAKING: SQLite provider completely removed**
- No native dependencies (better-sqlite3 removed)
- Simplified to console and memory providers only

### Changed
- Package now works everywhere without any native dependencies
- Smaller bundle size
- Perfect for Next.js Edge runtime and browser environments
